...
/**
 * The main class representing a game.
 * This class demonstrates the usage of teams and participants in a game.
 */
public class Game {
    public static void main(String[] args) {
        ...
        String serFileName = "scholarTeam.ser";
        scholarTeam.serialize(serFileName);
        Team<Participant> deserializedTeam = (Team<Participant>) Team.deserialize(serFileName);
